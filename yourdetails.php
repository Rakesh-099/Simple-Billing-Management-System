...
if($_SESSION['user_id'])
{
  $merch_id=$_SESSION['merch_idu'];
  $user_id=$_SESSION['user_idu'];
  $type=$_SESSION['statusu'];
  $sqlu="SELECT * FROM merchant_data WHERE PHONE_NO='$merch_id';";
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     <header class="mainhead">
        <h3 class="texi">Here you can view <?php echo $types; ?> transactions with <?php  echo $rowu["NAME"];?></h3>
